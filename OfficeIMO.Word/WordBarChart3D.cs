...
namespace OfficeIMO.Word {
    public class WordBarChart3D : WordChart {
        ...
        public static WordChart AddBarChart3D(WordDocument wordDocument, WordParagraph paragraph, string title = null, bool roundedCorners = false, int width = 600, int height = 600) {
        ...
        internal static BarChart CreateBarChart3D(BarDirectionValues barDirection = BarDirectionValues.Bar) {
        ...
        internal static BarChartSeries AddBarChart3DSeries<T>(UInt32Value index, string series, SixLabors.ImageSharp.Color color, List<string> categories, List<T> data) {
        ...
        private static Chart GenerateChartBar(Chart chart) {
            BarChart barChart1 = CreateBarChart3D();
